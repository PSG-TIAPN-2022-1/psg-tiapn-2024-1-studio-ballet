...
namespace APIJessicaOliveira2.Migrations
{
    ...
    [Migration("20240606131439_first-migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIJessicaOliveira2.Models.Financeiro", b =>
                {
                    ...
                    b.Property<DateTime>("DataBoleto")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("APIJessicaOliveira2.Models.Endereço", b =>
                {
                    b.HasOne("APIJessicaOliveira2.Models.Escola", "CnpjNavigation")
                        .WithMany()
                        .HasForeignKey("Cnpj")
            ...
            modelBuilder.Entity("APIJessicaOliveira2.Models.EndereçoAluno", b =>
                {
                    b.HasOne("APIJessicaOliveira2.Models.Aluno", "CpfNavigation")
                        .WithMany()
                        .HasForeignKey("Cpf")
            ...
            modelBuilder.Entity("APIJessicaOliveira2.Models.EndereçoProfessor", b =>
                {
                    b.HasOne("APIJessicaOliveira2.Models.Professor", "CpfNavigation")
                        .WithMany()
                        .HasForeignKey("Cpf")
            ...
            modelBuilder.Entity("APIJessicaOliveira2.Models.Horario", b =>
                {
                    b.HasOne("APIJessicaOliveira2.Models.Disciplina", "CodigoNavigation")
                        .WithOne("Horario")
                        .HasForeignKey("APIJessicaOliveira2.Models.Horario", "Codigo")
                        .IsRequired()
                        .HasConstraintName("FK_Horario_Disciplina");

                    b.HasOne("APIJessicaOliveira2.Models.Aluno", "CpfalunoNavigation")
                        .WithMany("Horarios")
                        .HasForeignKey("Cpfaluno")
                        .HasConstraintName("FK_Horario_Aluno");

                    b.HasOne("APIJessicaOliveira2.Models.Professor", "CpfprofessorNavigation")
                        .WithMany("Horarios")
                        .HasForeignKey("Cpfprofessor")
                        .HasConstraintName("FK_Horario_CPF_Professor");

                    b.HasOne("APIJessicaOliveira2.Models.SalaDeAula", "NumeroSalaNavigation")
                        .WithMany("Horarios")
                    ...
                    b.Navigation("CpfalunoNavigation");

                    b.Navigation("CpfprofessorNavigation");

                    b.Navigation("NumeroSalaNavigation");
                });

            modelBuilder.Entity("APIJessicaOliveira2.Models.Notas", b =>
                {
                    b.HasOne("APIJessicaOliveira2.Models.Aluno", "CpfNavigation")
                        .WithMany("NotaNavigation")
                        .HasForeignKey("Cpf")
